...
from .forms import SubmitDC, RunDC
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, os.path.dirname(os.path.realpath(__file__))+os.sep+directory,
                          {'process_name': process.process_name, 'result': 'NADA'})
